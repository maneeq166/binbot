...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070915] flex items-center justify-center p-4 text-[#FAFAF9] relative overflow-hidden">
      ...
      {/* 2. Login Card - Glass Morphism Premium Panel */}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="group">
              <div className="flex justify-between items-center mb-1.5 ml-1">
                <label className="block text-sm font-semibold text-[#917FBA] transition-colors group-focus-within:text-[#D3B4D2]">
                  Password
                </label>
                <span className="text-[13px] font-medium text-[#ACA7B6] hover:text-[#917FBA] transition-colors cursor-not-allowed">
                  Forgot password?
                </span>
              </div>
              <input
